...
function AddDoctor(props) {
  ...
  return (
    <Modal show={show} onHide={handleClose} className="doctor-custom-modal" style={{ maxWidth: 'none'}} backdropClassName="hospital-modal-backdrop">
      ...
      <Modal.Body className="pt-0 pb-0">
        ...
        <Button variant="outline-primary" onClick={handleClose} className="ps-5 pe-5">
          Back
        </Button>
